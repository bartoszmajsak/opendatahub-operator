...
func (r *DataScienceClusterReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	err := r.Client.List(context.TODO(), instances)
	if err != nil {
	...
	if instance.Name != req.Name {
		r.Log.Info("found different instance of DataScienceCluster", "name", instance.Name)
...
func (r *DataScienceClusterReconciler) reconcileSubComponent(instance *dsc.DataScienceCluster,
	...
	// Reconcile component
	err = component.ReconcileComponent(instance, r.Client, r.Scheme, r.ApplicationsNamespace)
